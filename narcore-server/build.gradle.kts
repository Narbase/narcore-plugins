...
//    ksp(projects.compilerPlugins)
    ...
    implementation("com.narbase.narcore:compiler-plugins:0.1.0")
    ksp("com.narbase.narcore:compiler-plugins:0.1.0")
...
narrator {
    ...
    sourceConfig {
        daosRelativePath = "daos"
        dtosRelativePath = "dtos"
        convertorsRelativePath = "conversions"
    }
    destinationConfig {
